...
function About() {
  usePageTitle("About Me - Banjo Yinka");
  const skills = [
    {
      category: "Frontend",
          ...
          >
            {skills.map((skillGroup, index) => (
              <motion.div
                ...
                whileTap={{ scale: 0.95 }}
                className="bg-gray-50 dark:bg-gray-900 p-6 rounded-lg border border-gray-200 dark:border-gray-800 hover:border-green-400 dark:hover:border-green-400 transition-colors cursor-pointer"
              >
